...
import { FaWallet, FaChartLine, FaLock, FaCheckCircle } from "react-icons/fa";
        ...
        <div className="max-w-7xl w-full flex flex-col-reverse lg:flex-row items-center justify-between gap-12">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4 leading-tight">
              Manage Your <span className="italic text-blue-600">Money</span>{" "}
              Smartly
            </h1>

            {/* Description */}
            <p className="text-gray-700 text-md mb-6 leading-relaxed">
              Take control of your finances with <strong>Fiscal-Fox</strong>.
              Easily track your <strong>income</strong> and{" "}
              <strong>expenses</strong>, view past transactions, and analyze
              your financial habits through helpful stats and charts.
            </p>
            {user ? (
              <div className="mb-6 ">
                <Link to="/dashboard">
                  <button className="bg-blue-400  font-semibold px-6 py-2 rounded-full shadow hover:bg-blue-500 transition duration-300 text-white">
                    Go To Dashboard
                  </button>
                </Link>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-gray-800 text-sm">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Log all transactions and stay in control.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Minimal interface. Powerful results.
                  </p>
                </div>
              </div>
            </div>
